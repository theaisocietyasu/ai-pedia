          ...
          {!isSubmitted ? (
            <>
              ...
              >
                {[
                  ...
                  <div key={index} className="glass-effect rounded-lg border border-white/10 text-center p-5">
              ...
              <motion.div
                ...
                className="glass-effect rounded-xl border border-purple/20 p-8 mb-8"
              >
            ...
            <>
              ...
              >
                ...
                <div className="glass-effect rounded-xl border border-green-500/20 p-8 mb-12">
                  <p className="text-sm text-light-gray/80 text-center">
